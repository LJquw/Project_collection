...
public class RentCarView extends JFrame{
	...
	private void initialize() {
		frame = new JFrame("租车信息管理(201931101137柳均)");
		...
		JLabel lblNewLabel = new JLabel("租车日期");
		...
		JLabel lblNewLabel_1 = new JLabel("租车用户");
		...
		JLabel lblNewLabel_2 = new JLabel("租车费用");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String rentDate = textField_1.getText().trim();
				...
				RentCar rentcar =new RentCar(id,rentDate,users,price,carID);
				if (e.getSource() == button_1) {
					if (rentDate == null || "".equals(rentDate)) {
						JOptionPane.showMessageDialog(null, "租车日期不能为空");
	                    return;
					}
					if (users == null || "".equals(users)) {
						JOptionPane.showMessageDialog(null, "租车用户不能为空");
	                    return;
					}
					if (price == null || "".equals(price)) {
						JOptionPane.showMessageDialog(null, "租车费用不能为空");
	                    return;
					}
					...
					new Database().addRentCarInfo(rentcar);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == button_2) {
					...
					new Database().updateRentCarInfo(rentcar);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == button_3) {
					...
					new Database().deleteRentCarInfo(id);
				  ...
				  table_1.removeAll();
					...
					if (list != null && list.size() > 0) {
						for (int i=0;i<list.size();i++) {
							...
							vector.add(rentcar.getId());
							vector.add(rentcar.getRentDate());
							vector.add(rentcar.getUsers());
							vector.add(rentcar.getPrice());
							vector.add(rentcar.getCarID());
